...
$check = "SELECT pb.id,u.email,p.privelage,pb.status FROM privelages_bt pb INNER JOIN privelages p on p.p_id = pb.p_id INNER JOIN users u on u.id = pb.user_id WHERE pb.user_id = {$_SESSION['userID']} AND p.p_id = 6";
...
$check_cat = "SELECT pb.id,u.email,p.privelage,pb.status FROM privelages_bt pb INNER JOIN privelages p on p.p_id = pb.p_id INNER JOIN users u on u.id = pb.user_id WHERE pb.user_id = {$_SESSION['userID']} AND p.p_id = 6 AND pb.status = 'suspended'";
                                ...
                                <tbody>
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            <button class='btn btn-primary' onclick='deleteRow({$row['id']})' >Delete</button>
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
