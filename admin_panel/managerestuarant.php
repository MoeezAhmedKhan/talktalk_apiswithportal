                                ...
                                <tbody>
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            echo "<td>{$sn}</td>";
                                            echo "<td>{$row['id']}</td>";
                                            echo "<td name='name'>{$row['user_id']}</td>";
                                            echo "<td name='email'>{$row['restuarant_name']}</td>";
                                            echo "<td name='email'>{$row['restuarant_description']}</td>";
                                            echo "<td name='email'>{$row['restuarant_address']}</td>";
...
function deleteRow(id){
    var req = new XMLHttpRequest();
      req.open("get","assets/Actions.php?FunctionName=DeleteRestuarant&id="+id,true);
      req.send();
