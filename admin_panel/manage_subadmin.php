                            ...
                            <table class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT `id`, `role_id`, `email`, `password`,`status`,`created_at` FROM `users` where role_id = 1";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            echo "<td name='password'>{$row['password']}</td>";
                                            ...
                                            echo "<td><button class = 'btn btn-primary'  onclick='openAddMore({$row['id']},{$index})' >Update</button></td>";
                                             echo "<td><a href='delete_subadmin.php?id=$row[id]'><button class='btn btn-primary' type='submit'>Delete</button></a></td>";
                                          echo "</tr>";
                                          $index++;
                                      }
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
        ...
        <h2>Edit News</h2>
         ...
         <input hidden type="text" name="id" id="id">  
             <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="text" name="email" id="Email" placeholder="Enter Name" > 
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control" value="" type="text" name="password" id="Password" placeholder="Enter Password" > 
                    </div>
                  </div>
       ...
       <button type="submit" name="btnUpdatesubusers" class="btn btn-primary">Submit</button>
       </form>
      </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,index){
     ...
     document.getElementById('Password').value = document.getElementsByName('password')[index].innerText;
