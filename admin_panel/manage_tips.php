...
$check = "SELECT pb.id,u.email,p.privelage,pb.status FROM privelages_bt pb INNER JOIN privelages p on p.p_id = pb.p_id INNER JOIN users u on u.id = pb.user_id WHERE pb.user_id = {$_SESSION['userID']} AND p.p_id = 8";
...
$check_cat = "SELECT pb.id,u.email,p.privelage,pb.status FROM privelages_bt pb INNER JOIN privelages p on p.p_id = pb.p_id INNER JOIN users u on u.id = pb.user_id WHERE pb.user_id = {$_SESSION['userID']} AND p.p_id = 8 AND pb.status = 'suspended'";
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Manage Tips</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Manage Tips
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage Tips</h4>
                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT `id`, `title` FROM `tip_title`";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            echo "<td><a href='update_title.php?id={$row['id']}'><button class='btn btn-primary'>Update</button></a>
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                      <?php
                                      include_once('connection.php');
                                         $users="SELECT `id`, `tip`, `created_at` FROM `tip_of_day`";
                                        $result = mysqli_query($conn,$users);
                                        $index = 0;
                                      while($row = mysqli_fetch_array($result)){
                                          $sn = $index+1;
                                          echo "<tr>";
                                            ...
                                            echo "<td><button class='btn btn-primary' onclick='openAddMore({$row['id']},{$index})' >Update</button>
                                             ...
                                             echo "<td><button class='btn btn-primary' onclick='deleteRow({$row['id']})' >Delete</button>
                                             </td>";
                                          echo "</tr>";
                                          $index++;
                                      }
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
        ...
        <h2>Edit News</h2>
         ...
         <input hidden type="text" name="id" id="id">  
             <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <div class="controls">
                        <textarea class="form-control" name="name" id="Name" rows="4" cols="50"></textarea>
                    </div>
                  </div>
       ...
       <button type="submit" name="btnUpdateTip" class="btn btn-primary">Submit</button>
       </form>
      </div>
...
function deleteRow(id){
    var req = new XMLHttpRequest();
      req.open("get","assets/Actions.php?FunctionName=DeleteTip&id="+id,true);
      req.send();
