        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Classes</h2>
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      foreach ($result as $class){
                                        $class_daysx = explode("#imp#",$class['class_days']);
                                        $class_timingsx = explode("#imp#",$class['class_timings']);
                                        $exercise_namex = explode("#imp#",$class['exercise_name']);
                                    ?>
                                    <tr>
                                        <td style="white-space: nowrap"><?php echo $class['id']?></td>
                                        <td style="white-space: nowrap"><?php echo $class['course_name']?></td>
                                        <td style="white-space: nowrap"><?php echo $class['description']?></td>
                                        <td style="white-space: nowrap">
                                            <?php
                                            foreach ($class_daysx as $row){
                                                 echo $row, "<br>";
                                            }
                                            ?>
                                        </td>
                                        ...
                                        <!--<div class="row">-->
                                        <!--    <a class="btn btn-primary btn-sm" href="#" role="button"><i class="fa fa-pencil" aria-hidden="true"></i></a>-->
