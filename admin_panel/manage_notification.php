...
$check = "SELECT pb.id,u.email,p.privelage,pb.status FROM privelages_bt pb INNER JOIN privelages p on p.p_id = pb.p_id INNER JOIN users u on u.id = pb.user_id WHERE pb.user_id = {$_SESSION['userID']} AND p.p_id = 4";
...
$check_cat = "SELECT pb.id,u.email,p.privelage,pb.status FROM privelages_bt pb INNER JOIN privelages p on p.p_id = pb.p_id INNER JOIN users u on u.id = pb.user_id WHERE pb.user_id = {$_SESSION['userID']} AND p.p_id = 4 AND pb.status = 'suspended'";
...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new notification.'){
       echo "<script>alert('Sucessfully added new notification.')</script>";
       header("Refresh: 1; url='addnotification.php'");
              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add New Notification
                    </li>
                  </ol>
                </div>
              </div>
...
<section class="simple-validation">
	<div class="row">
		<div class="col-md-12">
           ...
           <!--                                        <select class="form-control" name="NotUser">-->
           ...
           <!--     			    	</div>-->
						...
						<div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="NotiTitle" class="form-control" placeholder="Enter Notification title" required=""/>
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	<div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="notiContent" class="form-control" placeholder="Enter Notification content" required=""/>
                                    </div>
    							</div>
    						</div>
    			    	</div>
       ...
       <!--                             </div>-->
    			...
    			<!--    	</div>-->
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_insertNotification"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
