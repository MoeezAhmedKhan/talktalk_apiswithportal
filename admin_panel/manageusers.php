                            ...
                            <table class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT `id`, `role_id`, `name`, `email`, `password`, `phone`,`status`, `amount`, `profilepic`, `notification_token`, `isLoggedIn`, `created_at`, `updated_at` FROM `users` where role_id = 2";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            echo "<td><a href='delete_user.php?id={$row['id']}'><button class = 'btn btn-danger' type='submit'>Delete</button></td></a>";
                                          echo "</tr>";
                                          $index++;
                                      }
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
       ...
       <button type="submit" name="btnUpdateallUsers" class="btn btn-primary">Submit</button>
       </form>
      </div>
