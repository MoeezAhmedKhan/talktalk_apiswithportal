					...
					<form class="form-horizontal" action="assets/Actions.php" method="POST" enctype="multipart/form-data">
							<div class="row">
							    ...
							    <?php 
							        require_once("connection.php");
							        $id = $_GET ['id'];
							        $sql = "SELECT * FROM `privelages_bt` WHERE id = $id";
								...
								<div class="controls">
                                   <div class="controls">
                                        <select class="form-control" name="status">
                                            ...
                                            <option name="suspended">suspended</option>
                                        </select>
                                    </div>
    							</div>
    						</div>
       ...
       <!--                             </div>-->
    			...
    			<!--    	</div>-->
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_editsubadmin"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
