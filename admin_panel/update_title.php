...
// $check_cat = "SELECT pb.id, pb.user_id, pb.p_id,p.privelage FROM `privelages_bt` pb INNER JOIN `privelages` p ON pb.p_id = p.p_id WHERE p.p_id = 2 AND pb.user_id =".$_SESSION['userID'];
...
// if(!isset($_SESSION["privelage"]) || $_SESSION["privelage"] != "2")
// {
//     header("location:index.php");
// }
?>
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Update Title</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Update Title
                    </li>
                  </ol>
                </div>
              </div>
					...
					<form class="form-horizontal" action="assets/Actions.php" method="POST" enctype="multipart/form-data">
							<div class="row">
							    ...
							    <?php
							        ...
							        require_once("connection.php");
							        $t_id = $_GET['id'];
							        $sql = "SELECT `id`,`title` FROM `tip_title` WHERE id = $t_id";
						...
						<div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="title_id" class="form-control" value="<?php echo $ar['id'] ?>" hidden>
                                    </div>
    							</div>
    						</div>
    			    	</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="title_name" class="form-control" value="<?php echo $ar['title'] ?>">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnUpdate_title_name"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
