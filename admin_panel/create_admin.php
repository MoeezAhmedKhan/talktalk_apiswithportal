...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added subamin.'){
       echo "<script>alert('Sucessfully added subamin.')</script>";
       header("Refresh: 1; url='create_admin.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Create Admin</h2>
							...
							<div class="row">
            						<div class="col-sm-6">
            							<div class="form-group">
            								<div class="controls">
                                                <input type="email" name="adminEmail" class="form-control" placeholder="Enter Email" required="">
                							</div>
                						</div>
                			    	</div>
                			    	...
                			    	<div class="col-sm-6" >
                			    	    <div class="form-group">
                			    	        <div class="controls">
                			    	            <input type="text" name="adminPassword" class="form-control" placeholder="Enter Password" required="">
                			    	        </div>
                			    	    </div>
                			    	</div>
    			         ...
    			         <div class="row mb-2">
    			             <div class="col-md-12">
    			                  ...
    			                  <?php
                                        ...
                                        $fetch_prev = "SELECT `p_id`, `privelage` FROM `privelages`";
                                        $fetch_prev_exec = mysqli_query($conn,$fetch_prev);
                                        $prev_rows = mysqli_num_rows($fetch_prev_exec);
                                        if($prev_rows > 0)
                                        {
                                            while($prev_ar = mysqli_fetch_array($fetch_prev_exec))
                                            {
                                                ?>
                                                <div class="form-check">
                                                   <input class="form-check-input" type="checkbox" name="p_id[]" value="<?php echo $prev_ar['p_id'] ?>" id="defaultCheck1">
                                                     <label class="form-check-label csize" for="defaultCheck1">
                                                        <?php echo $prev_ar['privelage'] ?>
                                                     </label>
                                                </div>
                                                <?php
                                            }
							...
							<button type="Submit" name="btnSubmit_insertadmin"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
