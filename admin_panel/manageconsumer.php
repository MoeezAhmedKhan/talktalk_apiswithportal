        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Manage Consumers</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Manage Consumers
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage Consumers</h4>
                </div>
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT `id`,`email`,`name`,`status` from `users` WHERE `role_id` = 2 ";
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
       ...
       <button type="submit" name="btnUpdateConsumer" class="btn btn-primary">Submit</button>
       </form>
      </div>
...
function deleteRow(id){
    var req = new XMLHttpRequest();
      req.open("get","assets/Actions.php?FunctionName=DeleteConsumer&id="+id,true);
      req.send();
