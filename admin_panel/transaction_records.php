        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Transactions Record</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Transactions Record
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Transactions Record</h4>
                </div>
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $transactions['package']?></td>
                                        <td><?php echo $transactions['shedule_name']?></td>
                                        <td><?php echo $transactions['payment_id']?></td>
                                        <td><?php echo $transactions['payment_type']?></td>
                                        <td><?php echo $transactions['total_amount']?></td>
