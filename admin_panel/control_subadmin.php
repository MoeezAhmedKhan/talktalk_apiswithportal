...
// $check_cat = "SELECT pb.id, pb.user_id, pb.p_id,p.privelage FROM `privelages_bt` pb INNER JOIN `privelages` p ON pb.p_id = p.p_id WHERE p.p_id = 6 AND pb.user_id =".$_SESSION['userID'];
// $check_cat_exec = mysqli_query($conn, $check_cat);
// if(mysqli_num_rows($check_cat_exec) < 0)
// {
//     header("location:index.php");
// }

// if(!isset($_SESSION["privelage"]) || $_SESSION["privelage"] != "6")
// {
//     header("location:index.php");
// }
?>
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Control Sub Admin</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Control Sub Admin
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Control Sub Admin</h4>
                </div>
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT pt.id,u.email,p.privelage,pt.status FROM privelages p INNER JOIN privelages_bt pt on pt.p_id = p.p_id INNER JOIN users u on u.id = pt.user_id WHERE pt.id > 96 order by u.name ASC";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            echo "<td>{$row['privelage']}</td>";
                                            if($row['status'] == 'active'){
                                                 echo "<td style='color:green;' name='status'>{$row['status']}</td>";
                                             }else{
                                                 echo "<td style='color:red;' name='status'>{$row['status']}</td>";
                                             }
                                            echo "<td><a href='edit_subadmin.php?id=$row[id]'><button class='btn btn-primary'>Update</button></a></td>";
                                          echo "</tr>";
                                          $index++;
                                      }
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
       ...
       <button type="submit" name="btnUpdateCat" class="btn btn-primary">Submit</button>
       </form>
      </div>
