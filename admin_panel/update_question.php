...
session_start();
// If the user does not get to the Manage page
if(!isset($_SESSION['pageective']) && $_SESSION['pageective'] != true)
{
    header("location:index.php");
}
// require_once('connection.php');
// $check_cat = "SELECT pb.id, pb.user_id, pb.p_id,p.privelage FROM `privelages_bt` pb INNER JOIN `privelages` p ON pb.p_id = p.p_id WHERE p.p_id = 3 AND pb.user_id =".$_SESSION['userID'];
...
// if(!isset($_SESSION["privelage"]) || $_SESSION["privelage"] != "3")
// {
//     header("location:index.php");
// }
?>
...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new area.'){
       ...
       header("Refresh: 1; url='manage_questions.php'");

       
     }else{
        echo "<script>alert('Sucessfully added new question.')</script>";
     }
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Update Questions</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Update Questions
                    </li>
                  </ol>
                </div>
              </div>
		...
		<div class="col-md-12">
			<div class="card">
				...
				<?php
					    ...
					    require_once("connection.php");
					    $id = $_GET["id"];
					    $sql = "SELECT q.id,q.question,qc.category_name FROM questions q INNER JOIN questions_categories qc on qc.id = q.category_id WHERE q.id = $id";
							...
							<div class="row">
							    ...
							    <div class="col-sm-6">
        							<div class="form-group">
        								<div class="controls">
                                           <div class="controls">
                                           <input type="text" name="id" value="<?php echo $ar['id'] ?>" class="form-control" hidden>
                                            </div>
            							</div>
            						</div>
            			    	</div>
            						...
            						<div class="col-sm-12">
            							<div class="form-group">
            								<div class="controls">
                                                    <textarea class="form-control" name="question" rows="10" required=""><?php echo $ar['question'] ?></textarea>
